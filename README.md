...
# FEATURES
- General utils such as freezing transformations, deleting histor and centering pivots 
...
- Automative Squash and stretch funtions with the option to add pole vectors 

# BUG LOG
- Squash and stretch functions currently not fucntional. 
- Pole vector selection currently not fucntional 
...
- Add a general contrain options when using custom curve utils 
